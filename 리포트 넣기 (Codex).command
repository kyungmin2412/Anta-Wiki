#!/bin/bash
# Codex 로 리포트를 위키에 넣습니다 (추가 결제 없음)
cd "$(dirname "$0")" || exit 1

echo ""
echo "  리포트를 위키에 넣습니다 (Codex 사용 — 추가 결제 없음)"
echo "  ─────────────────────────────────────────"
echo ""
...
echo "  ─────────────────────────────────────────"
echo "  Codex 를 시작합니다."
echo "  처음이라면 로그인 창이 열립니다 — 평소 쓰는 ChatGPT 계정으로 로그인하세요."
echo "  그다음 리포트를 알아서 읽고 위키에 넣어줍니다."
echo "  ─────────────────────────────────────────"
echo ""

codex "reports 폴더에 있는 증권사 리포트 PDF를 모두 읽어서 위키에 넣어줘. 다 넣은 뒤에는 기업별로 종합 분석도 만들어줘."
